...
lyr_Neighborhoods_2015_0.set('fieldLabels', {'OBJECTID': 'no label', 'NEIGHBORH_': 'no label', 'NEIGHBORH1': 'no label', 'OLD_NEIGHB': 'no label', 'SUB_MUNC_I': 'no label', 'SUB_MUNC_A': 'no label', 'SUB_MUNC_E': 'no label', 'OLD_SUB_MU': 'no label', 'OLD_SUB__1': 'no label', 'NEIGHBOR_1': 'no label', 'POPULATION': 'inline label - always visible', 'DEV_AREA': 'no label', 'DEV_AREA_K': 'no label', 'STREETS_LE': 'no label', 'STREETS__1': 'no label', 'STREETS_AR': 'no label', 'STREETS__2': 'no label', 'SHAPE_AREA': 'no label', 'SHAPE_LEN': 'no label', 'Area': 'no label', });
